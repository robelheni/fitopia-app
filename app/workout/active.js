...
function makeStyles(c, dark) {
  ...
  return StyleSheet.create({
    ...
    restTitle: { fontSize: 14, fontWeight: '500', color: colors.blue },
    restTime: { fontSize: 48, fontWeight: '700', color: colors.blue, letterSpacing: -2 },
    ...
    overviewTextActive: { color: colors.blue, fontWeight: '600' },
    ...
    modalInstructionNumberText: { fontSize: 11, fontWeight: '700', color: colors.blue },
