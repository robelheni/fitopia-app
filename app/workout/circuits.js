...
export default function CircuitsScreen() {
  ...
  function startCircuit(circuit) {
    ...
    router.push({
      ...
      params: { circuitData: JSON.stringify(circuitData), workoutName: circuit.name },
    });
  }
...
function makeStyles(c, dark) {
  ...
  return StyleSheet.create({
    ...
    intro: { fontSize: 14, color: colors.grey, fontWeight: '300', lineHeight: 20, marginBottom: 20 },
    circuitCard: {
    ...
    circuitTop: { flexDirection: 'row', alignItems: 'center', gap: 14, marginBottom: 16 },
    circuitIcon: { width: 48, height: 48, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
    circuitMeta: { flex: 1 },
    circuitName: { fontSize: 17, fontWeight: '700', color: colors.black, letterSpacing: -0.3 },
    circuitDesc: { fontSize: 13, color: colors.grey, fontWeight: '300', marginTop: 2 },
    circuitStats: {
      flexDirection: 'row', backgroundColor: colors.greyCard, borderRadius: 12,
      padding: 14, marginBottom: 16, alignItems: 'center',
    },
    circuitStat: { flex: 1, alignItems: 'center' },
    circuitStatNumber: { fontSize: 18, fontWeight: '700', color: colors.black, letterSpacing: -0.5 },
    circuitStatLabel: { fontSize: 11, color: colors.grey, fontWeight: '300', marginTop: 2 },
    circuitStatDivider: { width: 1, height: 30, backgroundColor: colors.greyBorder },
    exerciseList: { gap: 8, marginBottom: 16 },
    exerciseRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
    exerciseDot: { width: 6, height: 6, borderRadius: 3 },
    exerciseName: { flex: 1, fontSize: 14, color: colors.black, fontWeight: '400' },
    exerciseTime: { fontSize: 13, color: colors.grey, fontWeight: '300' },
    startButton: {
