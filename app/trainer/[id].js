...
// ── Static trainer profiles for placeholder trainers ──────────────────────────
const STATIC_TRAINERS = {
  t1: {
    name: 'Dawit Bekele', initials: 'DB', avatarColor: '#2563EB', verified: true,
    speciality: 'Muscle Building', location: 'London, UK',
    experience: 8, clients: 142, sessions: 1240, rating: 4.9, price: 45, currency: '£', available: true,
    ...
    reviews: [
      { id: 'r1', name: 'Yonas B.', initials: 'YB', avatarColor: '#DC2626', rating: 5, text: 'Dawit completely transformed my approach to training. He understood my fasting schedule and built a plan around it. Down 8kg in 3 months.', time: '2 weeks ago' },
      { id: 'r2', name: 'Meron H.', initials: 'MH', avatarColor: '#D4A843', rating: 5, text: 'Finally a trainer who knows Ethiopian food. He told me exactly what to eat from our cuisine to hit my protein goals. No more guessing.', time: '1 month ago' },
      { id: 'r3', name: 'Sara T.', initials: 'ST', avatarColor: '#059669', rating: 5, text: 'Professional, knowledgeable and genuinely cares about results. Best investment I have made in my health.', time: '2 months ago' },
    ],
  },
  t2: {
    name: 'Sara Haile', initials: 'SH', avatarColor: '#059669', verified: true,
    speciality: 'Weight Loss', location: 'Minneapolis, US',
    experience: 6, clients: 98, sessions: 890, rating: 4.8, price: 55, currency: '$', available: true,
    ...
    reviews: [
      { id: 'r1', name: 'Dawit K.', initials: 'DK', avatarColor: '#7C3AED', rating: 5, text: 'Sara helped me lose 12kg without giving up injera. She showed me exactly how much to eat and when. Game changer.', time: '3 weeks ago' },
      { id: 'r2', name: 'Abebu T.', initials: 'AT', avatarColor: '#2563EB', rating: 5, text: 'Very knowledgeable about Ethiopian food. She created a meal plan using foods I actually enjoy eating.', time: '6 weeks ago' },
    ],
  },
  t3: {
    name: 'Yonas Tadesse', initials: 'YT', avatarColor: '#7C3AED', verified: true,
    speciality: 'Fasting Fitness', location: 'Toronto, CA',
    experience: 5, clients: 76, sessions: 620, rating: 4.7, price: 50, currency: '$', available: false,
    ...
    languages: ['English', 'Amharic'],
    reviews: [
      { id: 'r1', name: 'Meron G.', initials: 'MG', avatarColor: '#D97706', rating: 5, text: 'Yonas is the only trainer I have found who truly understands Orthodox fasting. My fitness improved even during the 55 day fast.', time: '1 month ago' },
    ],
  },
  t4: {
    name: 'Meron Girma', initials: 'MG', avatarColor: '#D97706', verified: false,
    speciality: 'General Fitness', location: 'Addis Ababa, Ethiopia',
    experience: 3, clients: 45, sessions: 380, rating: 4.6, price: 20, currency: '$', available: true,
    ...
    reviews: [
      { id: 'r1', name: 'Biruk A.', initials: 'BA', avatarColor: '#2563EB', rating: 5, text: 'Great trainer for beginners. Very patient and explains everything clearly in Amharic.', time: '2 months ago' },
    ],
  },
  t5: {
    name: 'Abebu Worku', initials: 'AW', avatarColor: '#DC2626', verified: true,
    speciality: 'Strength Training', location: 'Stockholm, SE',
    experience: 10, clients: 203, sessions: 2100, rating: 5.0, price: 60, currency: '€', available: true,
    ...
    reviews: [
      { id: 'r1', name: 'Tigist B.', initials: 'TB', avatarColor: '#7C3AED', rating: 5, text: 'Abebu is simply the best. 10 years of experience shows in every session. My strength has doubled in 6 months.', time: '1 week ago' },
      { id: 'r2', name: 'Kebede M.', initials: 'KM', avatarColor: '#059669', rating: 5, text: 'Worth every cent. Professional, results driven and understands the Ethiopian lifestyle completely.', time: '3 weeks ago' },
      { id: 'r3', name: 'Hiwot S.', initials: 'HS', avatarColor: '#D97706', rating: 5, text: 'I competed in my first fitness competition thanks to Abebu. His knowledge is unmatched.', time: '2 months ago' },
    ],
  },
};
...
export default function TrainerDetailScreen() {
  ...
  // Static trainer (placeholder IDs start with 't')
  const isStatic = String(id).startsWith('t');
  const staticTrainer = isStatic ? STATIC_TRAINERS[id] : null;

  const [apiTrainer, setApiTrainer] = useState(null);
  ...
  // Build a unified trainer object regardless of source
  const trainer = staticTrainer || (apiTrainer ? {
    name: apiTrainer.name,
    initials: apiTrainer.name.split(' ').map(w => w[0]).join('').substring(0, 2).toUpperCase(),
    avatarColor: '#2563EB',
    verified: apiTrainer.is_verified,
    speciality: apiTrainer.speciality,
    location: apiTrainer.location,
    experience: apiTrainer.years_experience,
    clients: apiTrainer.clients_trained,
    sessions: null,
    rating: null,
    price: apiTrainer.hourly_rate,
    currency: '£',
    available: apiTrainer.is_active,
    bio: apiTrainer.bio,
    tags: apiTrainer.speciality ? [apiTrainer.speciality] : [],
    certifications: apiTrainer.certifications ? [apiTrainer.certifications] : [],
    languages: apiTrainer.languages ? apiTrainer.languages.split(',').map(l => l.trim()) : [],
    instagram: apiTrainer.instagram,
    contact_email: apiTrainer.contact_email,
    reviews: [],
  } : null);
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <FadeUpItem delay={0}>
            <View style={styles.profileCard}>
              ...
              {!!trainer.speciality && <Text style={styles.speciality}>{trainer.speciality}</Text>}
              {!!trainer.location && (
          ...
          <FadeUpItem delay={100}>
            <View style={styles.statsRow}>
              ...
              {trainer.experience != null && trainer.clients != null && <View style={styles.statDivider} />}
              ...
              {trainer.rating != null && (
                <>
                  ...
                  <View style={styles.statItem}>
                    ...
                    <Text style={styles.statLabel}>{trainer.reviews?.length || 0} reviews</Text>
                  </View>
                </>
              )}
            </View>
            ...
            <View style={styles.bookingCard}>
              ...
              <View style={styles.bookingButtons}>
                <TouchableOpacity
                  ...
                  onPress={() => Alert.alert('Coming soon', 'Session booking is coming in the next update.')}
                >
                ...
                <TouchableOpacity
                  ...
                  onPress={() => Alert.alert('Coming soon', 'Messaging is coming in the next update.')}
                >
          ...
          {/* Contact links (API trainers) */}
          {(!!trainer.instagram || !!trainer.contact_email) && (
            <FadeUpItem delay={290}>
              ...
              <View style={styles.contactRow}>
                ...
                {!!trainer.contact_email && (
                  ...
                  >
                    ...
                    <Text style={[styles.contactButtonText, { color: colors.blue }]}>Send email</Text>
                  </TouchableOpacity>
                )}
              </View>
            </FadeUpItem>
          ...
          <FadeUpItem delay={350}>
            ...
            >
              <Text style={styles.bottomBookButtonText}>
                {trainer.available
                  ? `Book a session${trainer.price != null ? ` — ${trainer.currency}${trainer.price}` : ''}`
...
function makeStyles(colors, isDark) {
  return StyleSheet.create({
    ...
    messageButtonText: { fontSize: 15, fontWeight: '500', color: colors.blueText },
    ...
    tagText: { fontSize: 12, color: colors.blueText, fontWeight: '500' },

    certsList: { gap: 8, marginBottom: 24 },
    certItem: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: colors.greyCard, padding: 12, borderRadius: 12 },
    certText: { fontSize: 14, color: colors.black },

    languagesList: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 24 },
    languageTag: {
    ...
    languageText: { fontSize: 13, color: colors.black },
